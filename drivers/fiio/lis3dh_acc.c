...
#define FIIO_DEBUG_LIS3DH
#ifdef FIIO_DEBUG_LIS3DH
#define fiio_debug(x...)  printk(KERN_INFO "[fiio_lis3dh] " x)
#else
#define fiio_debug(x...)
#endif
...
static int lis3dh_acc_input_init(struct lis3dh_acc_status *stat)
{
	...
	stat->input_dev->id.vendor = 0x1001;
	stat->input_dev->id.product = 0x1001;
	stat->input_dev->id.version = 0x0101;
