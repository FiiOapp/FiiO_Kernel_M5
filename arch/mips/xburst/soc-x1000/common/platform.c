...
|| defined(CONFIG_SND_ASOC_FIIO_PCM5242) || defined(CONFIG_SND_ASOC_FIIO_AK4376) \
|| defined(CONFIG_SND_ASOC_FIIO_AK4377) || defined(CONFIG_SOUND_JZ_SPDIF_V12) \
||defined(CONFIG_SND_ASOC_JZ_AIC_SPDIF_V13))
	I2S_PORTB,
#endif
...
//#endif
	...
	SSI0_PORTD,
#endif
#if (defined(CONFIG_SND_ASOC_FIIO_AK4376) || defined(CONFIG_SND_ASOC_FIIO_AK4377))
	PO_EN_PORTA
#endif
};
struct jz_gpio_func_def platform_current_array[] = {

        SLCDC_PORTAB_8BIT_INPUT,
	SLCDC_PORTAB_16BIT_INPUT,
	SLCDC_PORTAB_16BIT_INPUT_1,
	MSC0_PORTA_4BIT_INPUT,
	PWM_PORTC_BIT0,
	PWM_PORTC_BIT4_INPUT,
};
...
/* end #ifndef CONFIG_FIIO_SOUND_BUILD_MODULE */


#ifdef  CONFIG_REGULATOR_AXP173
struct platform_device emxx_battery_device = {   
	.name           = "emxx-battery",
	.id             = -1,
};
#endif
...
#endif
#ifndef CONFIG_FIIO_DWC2_BUILD_MODULE
