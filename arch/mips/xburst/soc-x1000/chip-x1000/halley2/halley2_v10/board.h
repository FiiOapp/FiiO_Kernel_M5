...
/*1:host mode use otg function  0:device*/
#define GPIO_OTG_ID				GPIO_PB(7)
#endif

#ifdef CONFIG_M5_BORAD_2_0910
#define GPIO_USB_ID            	GPIO_PB(9)
/*1:host mode use otg function  0:device*/
#define GPIO_OTG_ID				GPIO_PB(9)
#endif
#define GPIO_USB_ID_LEVEL       LOW_ENABLE
#ifdef CONFIG_BOARD_HAS_NO_DETE_FACILITY
#define GPIO_USB_DETE           -1 /*GPIO_PC(22)*/
#define GPIO_USB_DETE_LEVEL     LOW_ENABLE
#define GPIO_USB_DETE_WAKEUP           GPIO_PB(11)
#else
...
#define AK4377_SCL GPIO_PB(23)
#define AK4377_SDA GPIO_PB(24)
#define PO_EN GPIO_PA(16)
#endif
...
#define GPIO_LCD_RST    GPIO_PB(14)//-1
...
/* BT OR Local Play Mode*/
#ifdef CONFIG_FIIO_PLAYER_CHECK
#define BT_PLAY_DETET GPIO_PC(4)
#endif
//BT_PW_EN
#define BT_RST     GPIO_PC(3)
#define BT_INT1		GPIO_PC(0)
#define ACTIVE_LOW_BT_INT1      1

/**
*1:source 0:sink
*/
#define BT_SWITCH_SINK_SOURCE		GPIO_PC(2)

#ifdef CONFIG_M5_BORAD_1_0629
#define BT_PW_EN GPIO_PD(3)
#define BT_VREG_ON GPIO_PC(19)
#endif

#ifdef CONFIG_M5_BORAD_2_0910
//蓝牙软件开机
#define BT_VREG_ON GPIO_PC(23) 
#endif

/*MMA8653 INT*/
#ifdef  CONFIG_FIIO_SENSORS_MMA865X
#define MMA8653_INT1 GPIO_PD(5)
#define MMA8653_INT2 GPIO_PD(4)
#endif

#ifdef  CONFIG_FIIO_SENSORS_LIS3DH
#define LIS3DH_INT1 GPIO_PD(5)
#define LIS3DH_INT2 GPIO_PD(4)
#endif
...
#define STK8323_INT1 GPIO_PD(5)
#define STK8323_INT2 GPIO_PD(4)
#endif
...
//CC
#ifdef CONFIG_M5_BORAD_2_0910
#define GPIO_CC_INT     GPIO_PB(7)
#endif

//usb host provide 5V vbus
#ifdef CONFIG_M5_BORAD_2_0910
#define GPIO_OTG_EN     GPIO_PB(13)
#define GPIO_USB_POWER_ON     GPIO_PB(8) //原测试点
#define GPIO_USB_CHANGE_EN        GPIO_PB(25)
#endif
...
//1  x   OFF      OFF
//OE
#define GPIO_USB_EN     GPIO_PC(22)   
//S
#define GPIO_S1_EN     GPIO_PC(21)
#endif

#define FIIO_M5_AUDIO_PATH_SPDIF (0)
#define FIIO_M5_AUDIO_PATH_I2S (1)

#ifdef CONFIG_M5_BORAD_2_0910
//set spdif out 
#define FIIO_M5_SPDIF_OUT 0
#define FIIO_M5_SPDIF_OFF 1
#define GPIO_SPDIF_OUT  GPIO_PD(3)
#endif

#ifdef CONFIG_M5_BORAD_2_0910
#define GPIO_M5_LED0 GPIO_PB(5)
#define GPIO_M5_LED1 GPIO_PB(21)
#define GPIO_M5_LED2 GPIO_PB(22)
#endif

#define FIIO_M5_PLAYER_NORMAL 0
#define FIIO_M5_PLAYER_BT_SINK 1
