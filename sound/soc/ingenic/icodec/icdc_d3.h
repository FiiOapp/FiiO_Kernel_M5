...
struct icdc_d3 {
	...
	int report_mask;
	int mix_cr_count;
	int playback_speed_sel;
	int playback_bit_width_sel;
	int capture_speed_sel;
	int capture_bit_width_sel;
	int capture_mute_count;
	int VIC_count;
	int amixer_set_mute;
	int dac_set_mute;
	int linein_set_mute;
...
#define  AK4376_DACL 0x61
#define  AK4376_DACR 0x62
#define  AK4376_BALANCE 0x63
#define  AK4376_VOLUME 0x64
/*aicr dac*/
