...
#define __interface_select_i2s(parent)      \
		jz_aic_set_reg(parent, SPCTRL, 0, SPCTRL_SPDIF_I2S_MASK, SPCTRL_SPDIF_I2S_BIT)
...
/*i2s_div*/
#define __i2s_set_sample_rate(parent,i2sclk, sync) \
	jz_aic_set_reg(parent, I2SDIV,(((i2sclk) / (4*64)) / (sync) ), I2SDIV_DV_MASK, I2SDIV_DV_BIT)
